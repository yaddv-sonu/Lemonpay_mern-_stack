            ...
            <div className="w-full  flex flex-col gap-[120px] md:flex-row items-center md:justify-between mx-auto z-10">
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center p-0 md:p-12">
                    <div className="w-full max-w-md mx-auto bg-transparent">
                        <h2 className="text-2xl md:text-[28px] font-bold text-white mb-2 text-center md:text-left" style={{ fontFamily: 'inherit' }}>Welcome Sign Up System</h2>
                        ...
                        <form className="flex flex-col gap-4">
                            ...
                            <div>
                                <label className="block text-white/90 mb-1 text-base" htmlFor="confirmPassword">Confirm Password</label>
                                <input
                                    id="confirmPassword"
                                    type="password"
